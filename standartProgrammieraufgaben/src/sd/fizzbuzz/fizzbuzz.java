...
public class fizzbuzz {
	...
	static int startwert = 1;
	static int endwert = 100;
	static String erg5Teiler = "fizz";
	static String erg7Teiler = "buzz";
	...
	public static void main (String[] args){
		 ...
		 * 		Verarbeitung, 
		 * 		Ausgabe
		 *  ist hier eigentlich nicht nötig und dient nur zur Uebung, das wesentliche FizzBuzz passiert in der Methode verarbeitung() */
	...
	private static void eingabe(String[] parameterArray){
		/*die Methode eingabe() kann natürlich auch ganz anders aussehen - ueber eine Usereingabe z.B.
		 * ich wurde aber mal bei einem Vorstellungsgespräch ueber den Programmaufruf mit Parametern und Verwendung von args gefragt
		...
		switch(anzahlParameter) {
			...
			break;
			case 1 : 
				startwert = Integer.valueOf(parameterArray[1]);
			break;
			case 2 : 
				startwert = Integer.valueOf(parameterArray[1]);
				endwert = Integer.valueOf(parameterArray[2]);
			break;
			default:			
		}
